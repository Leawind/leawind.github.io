...
features:
  - title: 微信
    details: 🔍💬 <img alt="微信赞赏码" src=/donate/wechat.webp style="width:100%;image-rendering:pixelated">
    icon: { src: /icons/wechat.svg }

  - title: 支付宝
    details: 💸👶 <img alt="支付宝" name=alipay src=/donate/alipay.webp style="width:100%;image-rendering:pixelated"></img>
